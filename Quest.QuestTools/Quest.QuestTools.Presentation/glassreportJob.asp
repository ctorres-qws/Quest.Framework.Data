...
<head>
  <title>Job Search Glass Report</title>
...
<!-- Added a script to include Sorttable.js to allow tables to be sorted on screen rather than by repeating SQL string  December 6th, Michael Bernholtz-->
 <script src="sorttable.js"></script>
    <div class="toolbar">
        ...
        <ul id="Profiles" title="Glass Report - Job Search" selected="true">
<% 
response.write "<li class='group'>Job Search GLASS REPORT </li>"
...
do while not rs.eof
	...
	response.write "<td><a class = 'greenButton' href='glassTimeLine.asp?gid="  & RS("ID") & "&ticket=job' target ='#_blank' >Time Line</a> </td>"
	response.write " </tr>"
	rs.movenext
loop
