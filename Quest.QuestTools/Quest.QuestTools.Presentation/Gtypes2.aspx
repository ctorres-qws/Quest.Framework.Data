...
<script runat="server">
	...
	Private Function ShowGTypes
		...
		Dim cn_SQL As New OleDb.OleDbConnection With {
			.ConnectionString = GetConnectionStr(false, true)
		}
	...
	Public Class Gtype
		...
		Dim cn_SQL As New OleDb.OleDbConnection With {
			.ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=F:\database\Quest.mdb;"
		}
			Dim cmd_Data As New OleDb.OleDbCommand
			Dim rdr_Data As OleDb.OleDbDataReader
			Dim str_SQL As String	
