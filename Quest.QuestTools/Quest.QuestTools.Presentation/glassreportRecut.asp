...
strSQL = "SELECT * FROM Z_GLASSDB WHERE [HIDE] IS NULL AND [DEPARTMENT] = 'Recut'  ORDER BY ID ASC"
rs.Cursortype = 2
rs.Locktype = 3
...
<% 
response.write "<li class='group'>Recut GLASS REPORT </li>"
...
do while not rs.eof
	...
	response.write "<td><a class = 'greenButton' href='glassTimeLine.asp?gid="  & RS("ID") & "&ticket=recut' target ='#_blank' >Time Line</a> </td>"
	response.write " </tr>"
	rs.movenext
loop
