...
strSQL = "SELECT * FROM Y_INV WHERE UCASE([Note 2]) = 'CC' AND WAREHOUSE = 'NASHUA' ORDER BY AISLE ASC, RACK ASC, Shelf ASC"
...
<% 
response.write "<li class='group'>All Nashua items Marked CC</li>"
