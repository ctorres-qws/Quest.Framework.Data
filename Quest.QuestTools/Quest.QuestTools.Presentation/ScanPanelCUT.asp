...
Select Case Machine	
	Case "1"
		OperatorName = "EuroMac - Alum"
	Case "2" 
		OperatorName = "HK Laser"
	Case "3"
		OperatorName = "Durma"
	Case Else
		OperatorName = "Karim"
...
<body>
    ...
    <form id="igline" title="CUT" class="panel" name="igline" action="ScanPanelCUT.asp" method="GET" selected="true">
         <h2>Panel Scan</h2>
		 	 
		 
		<div class="row">
			<a class="redButton" href="ScanPanelALL.asp?ScanType=Cut" target = "_self" >Full Menu</a> 
		</div>
