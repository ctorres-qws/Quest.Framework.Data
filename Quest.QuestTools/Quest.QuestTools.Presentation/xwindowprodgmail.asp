...
' CUTC#  contain the Jamb Machine Percentages in X_WIN_PROD	
	...
	Response.write "<tr title = 'Click on a Header to Sort by that Column' ><th>Job</th><th>Floor</th><th>Date</th><th>Glazed%<th>Cycles</th><th>Total Windows</th><th>Assembly</th><th>Date</th><th>Glazing</th><th>Date</th><th>Glazing2</th><th>Date</th><th>Forel</th><th>Willian</th>"
