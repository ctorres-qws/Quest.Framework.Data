...
strSQL = "Select * FROM X_BARCODEGA WHERE DAY = " & sDAY & " AND MONTH =" & SMonth & " AND YEAR = " & SYear &"  AND DEPT = 'FOREL1' ORDER BY DATETIME DESC"
...
<ul id="screen1" title="Quest Dashboard" selected="true">
		...
		<li><% response.write "FOREL1 Insulated Glass: " & totalgf %></li>
