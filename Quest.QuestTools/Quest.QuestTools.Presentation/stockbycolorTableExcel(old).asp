...
CASE "ALL"
	...
	strSQL = "SELECT * FROM Y_INV WHERE COLOUR = '"& colour &"' {0} ORDER BY PART ASC"
	strSQLAlt = "SELECT * FROM Y_INV WHERE Colour in(SELECT Project FROM Y_Color WHERE Project <> '" & colour & "' {0} AND Code IN(SELECT Code FROM y_color WHERE Project = '" & colour & "')) ORDER BY Colour ASC, PART ASC"
CASE "ANP"
	RESPONSE.WRITE "<li> Inventory Items not in Production/Scrap of the Colour: " & colour & "</li>"
	strSQL = "SELECT * FROM Y_INV WHERE COLOUR = '"& colour &"' AND WAREHOUSE <> 'WINDOW PRODUCTION' AND WAREHOUSE <> 'COM PRODUCTION' AND WAREHOUSE <> 'JUPITER PRODUCTION' AND WAREHOUSE <> 'SCRAP' {0} ORDER BY PART ASC"
	strSQLAlt = "SELECT * FROM Y_INV WHERE WAREHOUSE <> 'WINDOW PRODUCTION' AND WAREHOUSE <> 'COM PRODUCTION' AND WAREHOUSE <> 'JUPITER PRODUCTION' AND WAREHOUSE <> 'SCRAP' {0} AND Colour in(SELECT Project FROM Y_Color WHERE Project <> '" & colour & "' AND Code IN(SELECT Code FROM y_color WHERE Project = '" & colour & "')) ORDER BY Colour ASC, PART ASC"
CASE "GN"
...
CASE Else
	...
	strSQL = "SELECT * FROM Y_INV WHERE COLOUR = '"& colour &"' AND WAREHOUSE = '" & warehouse & "' {0} ORDER BY PART ASC"
...
if warehouse = "GOREWAY" or warehouse = "NASHUA" or warehouse = "GN" then
