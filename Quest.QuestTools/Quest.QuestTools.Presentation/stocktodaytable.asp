...
strSQL = "SELECT * FROM Y_INV WHERE DATEIN = #" & currentDate & "# ORDER BY WAREHOUSE, PART"
rs.Cursortype = 2
rs.Locktype = 3
...
<body>
    <div class="toolbar">
        ...
        <ul id="Profiles" title="Stock Entered <% response.write CurrentDate %>" selected="true">
         <li class="group"><a href="stocktoday.asp?part=<%response.write part%>&CDay=<%response.write CDay%>" target="_self" >Stock Today (Table Form) - Switch to Row Form</a></li>
...
Response.write "<li class='group'>EXTRUDEX</li>"
Response.WRITE "<li><table border='1' class='sortable'>"
Response.WRITE "<tr><th>Part</th><th>Description</th><th>Quantity (SL)</th><th>Colour</th><th>PO</th><th>Bundle</th><th>Length(Ft)</th></tr>"
