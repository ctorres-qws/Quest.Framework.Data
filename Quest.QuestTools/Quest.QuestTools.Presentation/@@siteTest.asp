<%
	...
	gstr_FolderUploadRecords = "C:/Inetpub/wwwroot/Barcode/UploadRecords/"
	...
	'gstr_DB_Access_Prod = "DRIVER={Microsoft Access Driver (*.mdb)}; " & "DBQ=Z:\quest.mdb;"
	'gstr_DB_Access_Prod = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=\\QI78GBOV-LT003\QuestTools\quest.mdb;" 'michelletest
	'gstr_DB_Access_Prod = "DRIVER={Microsoft Access Driver (*.mdb)}; " & "DBQ=\\172.18.13.31\database\quest.mdb;"
	'gstr_DB_Access_Prod = "DRIVER={Microsoft Access Driver (*.mdb)}; " & "DBQ=\\tackleberry\_Databases\quest.mdb;"
	gstr_DB_Access_Prod = "DRIVER={Microsoft Access Driver (*.mdb)}; " & "DBQ=\\QI78GBOV-LT003\QuestTools\quest.mdb;" 'michelletest
