...
<!--Requested by Shaun Levy and Lev Bedeov - This report displays items in Nashua that were entered more than 3 months ago-->
<!-- This report will help clear up old items in the inventory - Relies on Warehouse Nashua and Input Date -->
...
strSQL2 = "SELECT PROJECT,CODE FROM Y_COLOR"
'rs2.Cursortype = 2
'rs2.Locktype = 3
...
<body>
    <div class="toolbar">
        ...
        <ul id="Profiles" title="NASHUA Stock Older Than <% response.write oldDate %>" selected="true">
        
<% 

response.write "<li class='group'>Old Stock</li>"
RESPONSE.WRITE "<li><table border='1' class='sortable'>"
RESPONSE.WRITE "<tr><th>Part</th><th>Date Entered</th><th>Qty</th><th>Original Qty</th><th>Aisle</th><th>Rack</th><th>Shelf</th><th>Colour</th><th>Code</th><th>PO</th><th>Bundle</th><th>Length(Ft)</th></tr>"
...
rs2.filter = "PROJECT = '" & rs("Colour") & "'"
if rs2.eof then
Response.write "<td>N/A</td>"
else
Response.write "<td>" & rs2("code") & " </td>"
end if
