...
<body onload="startTime()" >
    ...
    <div class="toolbar">
        <h1 id="pageTitle"></h1>
              ...
              <form id="edit" title="Select Stock by PO" class="panel" name="edit" action="stockbypo.asp" method="GET" target="_self" selected="true" > <form id="delete" title="Edit Stock" class="panel" name="delete" action="stockeditconf.asp" method="GET" target="_self" selected="true" >
        <h2>Search Pending Stock by PO</h2>
...
<fieldset>
     <div class="row">
        ...
        <BR>
        <a class="whiteButton" href="javascript:edit.submit()">Search pending stock by PO</a><BR>
