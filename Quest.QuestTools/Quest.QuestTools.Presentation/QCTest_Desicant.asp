...
strSQL = "SELECT * FROM TEST_Desicant ORDER BY DATE DESC"
rs.Cursortype = 2
rs.Locktype = 3
...
<body>
    <div class="toolbar">
        ...
        <ul id="Profiles" title=" Desicant" selected="true">
        <li class='group'>Desicant Test </li>
         <a class="whiteButton" href="QCTest_DesicantEnter.asp" target='_Self'>Add New Result</a>
<% 

response.write "<li> Click on the Headers of each column to sort Ascending/Descending</li>  "
response.write "<li><table border='1' class='sortable' ><thead><tr><th>Date</th><th>Time</th><th>T1</th><th>T2</th><th>Result</th><th>Temp Passed?</th><th>Name</th><th>Notes</th><th>File</th></tr></thead><tbody>"
if rs.eof then
