...
<body onload="startTime()" >
    ...
    <div class="toolbar">
        <h1 id="pageTitle"></h1>
              ...
              <form id="edit" title="Select Stock by PO" class="panel" name="edit" action="allbybundle.asp" method="GET" target="_self" selected="true" > 
        <h2>Search ALL Stock by Bundle</h2>
...
<fieldset>
     <div class="row">
        ...
        <BR>
        <a class="whiteButton" href="javascript:edit.submit()">Search ALL stock by Bundle</a><BR>
