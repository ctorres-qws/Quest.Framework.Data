...
strSQL = FixSQL("SELECT * FROM Y_INV WHERE (DATEIN < #" & oldDate & "# OR DATEIN = NULL) AND Warehouse = 'GOREWAY' ORDER BY PART ASC, DATEIN DESC ")
rs.Cursortype = 2
rs.Locktype = 3
...
%>
      <li>//END//</li>
	  <li><b>Port number:</b><%Response.Write(Request.ServerVariables("SERVER_PORT"))%></li>
	  <li><b>IP ADDRESS:</b><%Response.Write(Request.ServerVariables("REMOTE_ADDR"))%></li>
	  </ul>                 
