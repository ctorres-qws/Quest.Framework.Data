...
<ul id="screen1" title="Department Drill Down Stats" selected="true">
		...
		<li class="group">GlassLine Drill Down</li>
<%

Set rs = Server.CreateObject("adodb.recordset")
strSQL = "Select * FROM X_BARCODEGA WHERE DEPT = 'FOREL' ORDER BY JOB ASC"
...
Response.write "<li class='group'>Today (Forel)</li>"	
if rs.eof then
...
Response.write "<li class='group'>This Week (Forel)</li>"	
if rs.eof then
	response.write "<li> There are currently no items of Activity Today, Please check later</li>"
else
	Job1 =  UCASE(rs("Job"))
...
Set rs = Server.CreateObject("adodb.recordset")
strSQL = "Select * FROM X_BARCODEGA WHERE DEPT = 'Willian' ORDER BY JOB ASC"
'rs.Cursortype = GetDBCursorType
'rs.Locktype = GetDBLockType
'rs.Open strSQL, DBConnection
Set rs = GetDisconnectedRS(strSQL, DBConnection)
...
Response.write "<li class='group'>Today (Willian)</li>"	
if rs.eof then
	response.write "<li> There are currently no items of Activity Today, Please check later</li>"
else
	Job1 =  UCASE(rs("Job"))
...
Response.write "<li class='group'>This Week (Willian)</li>"	
if rs.eof then
	response.write "<li> There are currently no items of Activity Today, Please check later</li>"
else
	Job1 =  UCASE(rs("Job"))
