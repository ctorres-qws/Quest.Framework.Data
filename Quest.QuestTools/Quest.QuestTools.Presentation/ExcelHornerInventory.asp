...
Response.AddHeader "Content-Disposition", "attachment; filename=HornerInventory" & Date() & ".xls"
%>

<%

Set rs = Server.CreateObject("adodb.recordset")
strSQL = "SELECT * FROM Y_INV WHERE WAREHOUSE = 'HORNER' ORDER BY BUNDLE ASC, AISLE ASC, RACK ASC"
rs.Cursortype = 2
rs.Locktype = 3
...
response.write "<li><table border='1' class='sortable'>"
			Response.write "<tr><td>Horner Inventory</td></tr>"
			Response.write "<tr><td>BY: </td><td></td></tr>"
			Response.write "<tr><td>Checked:</td><td></td></tr>"
			Response.write "<tr><td>Entered:</td><td></td></tr>"
			response.write "<tr><th>Aisle</th><th>Rack</th><th>Shelf</th><th>Part</th><th>Quantity</th><th>PO</th><th>Bundle</th><th>External Bundle</th><th>Colour</th><th>Input Date</th><th>Size</th><th>Quantity</TH><TH>Delta</TH></tr>"
do while not rs.eof
