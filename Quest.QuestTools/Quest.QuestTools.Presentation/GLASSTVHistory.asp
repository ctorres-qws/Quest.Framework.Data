...
<body>
 ...
 <form id="GlassProduction" title="Glass Production" class="panel" name="GlassProduction" action="GlassTV.asp" method="GET" selected="true">
	...
	<!--	
		...
		<input type="button" value="Click me" onclick="msg2()">
		<script>
