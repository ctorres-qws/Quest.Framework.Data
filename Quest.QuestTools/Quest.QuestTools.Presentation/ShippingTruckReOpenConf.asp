...
if dockNum = "" then
	...
	'Re-Open Closed Truck  ( Remove shipDate, set active = True, Set New Dock)
		...
		SQL = FixSQLCheck("UPDATE X_SHIPPING_TRUCK SET shipDate = NULL , dockNum = '" & dockNum & "', active= TRUE  WHERE id = " & truck,isSQLServer)
			'Get a Record Set
		...
		SQL2 = "UPDATE X_SHIPPING SET shipDate = NULL  WHERE truck = " & truck
			'Get a Record Set
...
<body>
    <div class="toolbar">
        <h1 id="pageTitle"></h1>
        <a class="button leftButton" type="cancel" href="ShippingHome.HTML" target="_self">Ship</a>
        </div>
...
if IsError = true then
	...
	response.write " <a class='whiteButton' href=' ShippingTruckReOpen.asp' target='_self'>Back to Re-Open Truck Form</a>"
else
