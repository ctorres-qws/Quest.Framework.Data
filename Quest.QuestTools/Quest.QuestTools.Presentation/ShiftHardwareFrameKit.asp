...
<head>
  <title>Frame Kit - Shift Entry</title>
...
'	Response.write "<li> Cart: " & BCART* i & "</li>"
 ...
 Response.write "<li> Column: " & PositionX + 1 & "</li>"
	...
	if ItemCheck = "" then
		...
		Response.write "<TR>"
			Response.write "<TD>" 
				Response.write "<B><CENTER><font size='12'>" & rs("H-132S") & "</font></CENTER></B>"
				Response.write "<center>H-132S</center><br>"
				Response.write "<img src='/HardwarePics/H-132S.png'/>"
			Response.write "</TD>" 
			Response.write "<TD>" 
				Response.write "<B><CENTER><font size='12'>" & rs("H-131RS") & "</font></CENTER></B>"
				Response.write "<center>H-131RS</center><br>"
				Response.write "<img src='/HardwarePics/H-131RS.png'/>"
				
			Response.write "</TD>" 
			Response.write "<TD>" 
				Response.write "<B><CENTER><font size='12'>" & rs("H-131LS") & "</font></CENTER></B>"
				Response.write "<center>H-131LS</center><br>"
				Response.write "<img src='/HardwarePics/H-131LS.png'/>"
				
			Response.write "</TD>" 
			Response.write "<TD>" 
				Response.write "<B><CENTER><font size='12'>" & rs("H-131R") & "</font></CENTER></B>"
				Response.write "<center>H-131R</center><br>"
				Response.write "<img src='/HardwarePics/H-131R.png'/>"
				
			Response.write "</TD>" 
			Response.write "<TD>" 
				Response.write "<B><CENTER><font size='12'>" & rs("H-131L") & "</font></CENTER></B>"
				Response.write "<center>H-131L</center><br>"
				Response.write "<img src='/HardwarePics/H-131L.png'/>"
				
			Response.write "</TD>" 
			Response.write "<TD>" 
				Response.write "<B><CENTER><font size='12'>" & rs("H-132") & "</font></CENTER></B>"
				Response.write "<center>H-132</center><br>"
				Response.write "<img src='/HardwarePics/H-132.png'/>"
...
<input type="hidden" name="Ticket" value= "FRAME">  
...
if ((FirstID = CurrentID) or (CurrentID = 0)) and First = "" then
else
rs.Movenext
end if
if rs.eof then
...
<FORM METHOD="GET" ACTION="ShiftHardwareFrameKit.asp" target="_self">
<input type="hidden" name="Job" value= <%Response.write Job%>>
<input type="hidden" name="Floor" value= <%Response.write Floor%>>  
