...
<!-- Confirm Page - Entered from QCTest_CuringEnter.asp -->
...
CuringTime = REQUEST.QueryString("CuringTime")
...
strSQL = "SELECT * FROM TEST_Curing"
rs.Cursortype = 2
rs.Locktype = 3
...
<body >
    ...
    <div class="toolbar">
        ...
        <a id="backButton" class="button" href="#"></a>
                <a class="button leftButton" type="cancel" href="QCTest_CuringENTER.asp" target="_self">Back</a>
...
<ul id="Report" title="Added" selected="true">
	...
	<li><% response.write "Curing Time: " & CuringTime %></li>
	...
	<a class="whiteButton" href="QCTest_Curing.asp" target="_self">Confirm and Return</a>
</ul>
