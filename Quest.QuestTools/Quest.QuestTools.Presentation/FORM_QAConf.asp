...
<!-- Confirm Page - Entered from FORM_QAEnter.asp -->
...
<body >
    ...
    <div class="toolbar">
        ...
        <a id="backButton" class="button" href="#"></a>
                <a class="button leftButton" type="cancel" href="FORM_QAENTER.asp" target="_self">Back</a>
...
<ul id="Report" title="Added" selected="true">
	...
	<li><% response.write "NDMR: " & NDMR %></li>
	<li><% response.write "Notes: " & Notes %></li>
	<li><% response.write "Checked By: " & CheckedBy %></li>
	<a class="whiteButton" href="Form_QA.asp" target="_self">Confirm and Return</a>
</ul>
