...
strSQL = "SELECT * FROM Y_INV WHERE WAREHOUSE = 'DURAPAINT' OR WAREHOUSE = 'DURAPAINT(WIP)' ORDER BY ALLOCATION DESC"
rs.Cursortype = 2
rs.Locktype = 3
...
<ul id="screen1" title="Stock by Die" selected="true">
	...
	Response.Write "<li class='group'><a href='stockbydieDurapaintTable.asp?part=" & part & "' target='_self' >Stock (Row Form) - Switch to Table Form</a></li>"
