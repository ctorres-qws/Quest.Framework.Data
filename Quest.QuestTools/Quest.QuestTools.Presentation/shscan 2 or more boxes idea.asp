    ...
    <form id="ship" title="Scan Multiple Windows" class="panel" name="ship" action="shscan.asp" method="GET" target="_self" selected="true">
        ...
        <fieldset>
                ...
                <textarea name="multi" cols="46" rows="5" id="inputbcw" padding="55"></textarea>
                               <textarea name="multi" cols="46" rows="5" id="inputbcw2" padding="55"></textarea>
                ...
                <% 
'my_array = multi.Split(",")

  For i = 1 To Request.QueryString("Multi").Count    
    Response.Write Request.QueryString("Multi")(i) & "<BR>"
  Next 
...
%>
    ...
    if ( textbox.value == "" ) {
        textbox.value = barcode;
		    ...
		    var textbox2 = document.getElementById("inputbcw2");
        textbox2.value += barcode;
    }
}
