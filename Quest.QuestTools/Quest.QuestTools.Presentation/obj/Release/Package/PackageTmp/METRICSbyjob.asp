...
strSQL = "Select * FROM X_BARCODE WHERE WEEK = " & weekNumber & " AND YEAR = " & cYear & " AND DEPT ='ASSEMBLY' ORDER BY JOB ASC"
rs.Cursortype = 2
rs.Locktype = 3
...
<li class="group">Week's Total Stats</li>
	...
	response.write "<li>Assembly Total: " & atotal & "</li>"
...
'response.write "<li>" & lastjob & " OPENINGS: " & totalo & " JOINTS: " & totalj & ", O/W: " & round((totalo/gtotal),1) & " J/W: " & round((totalj/atotal),1) &    "</li>"
	...
	response.write "<li>Glazing Total: " & gtotal & "</li>"
