...
<!-- Updated for Global Variables Updates by Annabel Ramirez November 13, 2019 -->
...
'additional fields to capture from parent job ARAMIREZ Nov 13, 2019 Requested by Jayesh. Confirmed with Michael B.
MaxHoist= RS("MaxHoist")
VStockLength=RS("VStockLength")
JobStatus=RS("JobStatus")
STOPCOLOR=RS("STOPCOLOR")
NODOORS=RS("NODOORS")
NOAWNINGS = RS("NOAWNINGS")
SCREEN= RS("Screen")
ATHICK= RS("CasAwnThick")
AWNSTYLE=RS("AwnStyle")
EXTGLASS=RS("EXTGLASS")
EXTGLASSDOOR=RS("ExtGlassDoor")
FSTYLE=RS("FRAMESTYLE")
INTGLASS=RS("IntGlass")
INTGLASSDOOR=RS("IntGlassDoor")
LOUVERSTYLE=RS("Louverstyle")
OVSPACER=RS("OVSPACER")
SILLTYPE=RS("SillType")
SPACERCOLOUR=RS("SpacerColour")
STHICK=RS("SwingDoorThick")
SUSPACER=RS("SUSPACER")
WTHICK=RS("FixWindowThick")
SWSPACER=RS("SWSPACER")																												  
...
' include additional fields to capture from parent job ARAMIREZ Nov 13, 2019
