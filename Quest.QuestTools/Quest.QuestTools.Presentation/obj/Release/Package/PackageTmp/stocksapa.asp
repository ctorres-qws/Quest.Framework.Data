...
rs.filter = "WAREHOUSE='SAPA'"

response.write "<li class='group'>SAPA</li>"
...
<body>
    <div class="toolbar">
        ...
        <ul id='SAPA' title=' SAPA Inventory' selected='true'> 
		<li class='group'>SAPA INVENTORY </li>
...
Response.write "<td><a href='stockbyrackedit.asp?ticket=stocksapa&id=" & rs("id") & "' target='_self'>Manage</a></td>"
