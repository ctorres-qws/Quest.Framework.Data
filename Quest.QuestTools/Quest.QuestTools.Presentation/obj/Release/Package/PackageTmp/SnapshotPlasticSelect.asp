...
<!-- Individual Plastic Report created June 2019 - Request Ariel Aziza -->
<!-- SnapShotPlasticSelect SnapShotPlasticValue-->

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
  <title>Plastic Snapshot Report</title>
...
<body>
  <div class="toolbar">
        <h1 id="pageTitle">Plastic Snapshot Report</h1>
		<% 
    ...
    <form id="snapshot" title="Take Inventory Snapshot" class="panel" name="snapshot" action="SnapShotPlasticValue.asp" method="GET" target="_self" selected="true">
        <h2>Select a Snapshot of Plastic Inventory</h2>
        <fieldset>
