...
truck = Request.Querystring("Truck")
	...
	strSQL = "SELECT * FROM X_Shipping_Truck  ORDER BY ID ASC"
	rs.Cursortype = 2
	rs.Locktype = 3
...
<body>
   ...
   <!--New Form to collect the Job and Floor fields-->
    <form id="CloseTruck" title="Close Truck" class="panel" name="CloseTruck" action="ShippingTruckCloseConf.asp" method="GET" selected="true">
...
%>
        ...
        <BR>
			<a class="redButton" onClick="CloseTruck.action='ShippingTruckCloseConf.asp'; CloseTruck.submit()">Confirm and Close Truck</a><BR>
		   </form>
