...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"
		 ...
		 <!--Durapaint version of Stock levels, created for Ruslan Bedoev by Michael Bernholtz, May 22, 2014 -->
...
<ul id="screen1" title="Stock Level - Durapaint" selected="true">            

<%
Set rs = Server.CreateObject("adodb.recordset")
strSQL = "SELECT * FROM Y_INV WHERE WAREHOUSE = 'DURAPAINT'  OR WAREHOUSE = 'DURAPAINT(WIP)' order by PART ASC"
rs.Cursortype = 2
rs.Locktype = 3
...
response.write "<li class='group'>Stock by Die - Durapaint Only</li>"
...
do while not rs2.eof
	...
	if partqty = 0 and allocatedqty = 0 and paintedqty = 0 then
		...
		response.write "<tr><td><a href='stockbydieDurapaint.asp?part=" & rs2("Part") & "' target='_self'>" & rs2("part") & "</a></td><td>" & rs2("Description") & "</td><td>" & partqty & "</td><td>" & allocatedqty & "</td><td>" & paintedqty & "</td><td>" & Totalqty & "</td></tr>"
	end if 
