...
strSQL = "SELECT * FROM TEST_HotMelt ORDER BY DATE DESC"
rs.Cursortype = 2
rs.Locktype = 3
...
<body>
    <div class="toolbar">
        ...
        <ul id="Profiles" title=" Hot Melt" selected="true">
        <li class='group'>HotMelt Test </li>
         <a class="whiteButton" href="QCTest_HotMeltEnter.asp" target='_Self'>Add New Result</a>
<% 

response.write "<li> Click on the Headers of each column to sort Ascending/Descending</li>  "
response.write "<li><table border='1' class='sortable' ><thead><tr><th>Date</th><th>Time</th><th>Batch</th><th>Set</th><th>Applied</th><th>Adhesion Passed?</th><th>Name</th><th>Notes</th><th>File</th></tr></thead><tbody>"
if rs.eof then
...
do while not rs.eof
	...
	response.write "<td>" & RS("Batch") &"</td>"
	response.write "<td>" & RS("Set") &"</td>"
	response.write "<td>" & RS("Applied") &"</td>"
