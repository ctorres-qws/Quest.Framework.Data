...
Mail.Subject="Extrusion Entered Today/Yesterday"
...
Mail.CreateMHTMLBody "http://172.18.13.31:8081/stocktodayEmail.asp" 'Sends an email which has a body of a specified webpage
...
Set Mail = Nothing
%>     
<p> Daily Production ~ E-mail Sent </p>
</body>
</html>
