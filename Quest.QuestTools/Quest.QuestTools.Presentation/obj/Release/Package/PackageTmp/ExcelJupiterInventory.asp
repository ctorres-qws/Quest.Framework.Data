...
<!--Import into JUPITER Inventory into Excel for Inventory Counts -->
<!-- Table Values Organized by Aisle Rack Shelf-->
<!-- JUPITER Inventory Requested by David Jan 2020-->
...
Response.AddHeader "Content-Disposition", "attachment; filename=JUPITERInventory" & Date() & ".xls"
%>
