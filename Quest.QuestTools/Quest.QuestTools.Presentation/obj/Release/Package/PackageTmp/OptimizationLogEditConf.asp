...
<%	
		...
		'Added at request of Jody and Ruslan - Optimization Automatically marks received and has the ability to create backorder, Feb 2015
if isDate(ReceivedDate) then
Response.write "</ul><h2>Below Glass Items with Matching MO Code are being marked Received:</h2><ul>"

Set DBConnection = Server.CreateObject("adodb.connection")
DBConnection.Open GetConnectionStr(isSQLServer)
