...
strSQL = "SELECT DATESTAMP, JOB, FLOOR, TOTALWIN, TOTALPanels, TOTALDoor, TOTALSQFT FROM X_WIN_PROD WHERE [DATESTAMP]< #09/01/2017# AND [DATESTAMP]> #08/31/2016# ORDER BY JOB ASC, FLOOR DESC"
rs.Cursortype = 2
rs.Locktype = 3
...
response.write "<li> ALL Window Production info from August 31st, 2016 to September 1st, 2017</li>  "
