...
<ul id="screen1" title="Stock by Die" selected="true">
	...
	Response.Write "<li class='group'><a href='stockbydieHornerTable.asp?part=" & part & "' target='_self' >Stock (Row Form) - Switch to Table Form</a></li>"
...
response.write " " & rs.fields("Lft") & "' " & " " & rs.fields("Qty") & " SL" & " PO" & po & " / " & rs.fields("Bundle") & " " & rs.fields("Lmm") & " mm" &"</li>"
End Select'response.write "<li>- Aisle " & rs.fields("Aisle") & " Rack " & rs.fields("rack") & " Shelf " & rs.fields("shelf") & "</li>"
