...
<body>
    ...
    <form id="igline" title="SHIP" class="panel" name="igline" action="ScanPanelSHIP.asp" method="GET" selected="true">
         <h2>Panel Scan</h2>
		 	 
		 
		<div class="row">
			<a class="redButton" href="ScanPanelALL.asp?ScanType=RECEIVE" target = "_self" >Full Menu</a> 
		</div>
        ...
        <fieldset>
	        ...
	        <div class="row">
                ...
                <input type="text" name='employeeID' id='inputbce' value = 'Amell' >
            </div>
