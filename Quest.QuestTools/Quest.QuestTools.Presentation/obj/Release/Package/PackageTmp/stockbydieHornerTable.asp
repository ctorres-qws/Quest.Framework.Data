...
strSQL = "SELECT * FROM Y_INV WHERE WAREHOUSE = 'Horner' ORDER BY AISLE, RACK, SHELF ASC"
rs.Cursortype = 2
rs.Locktype = 3
...
<body onload="startTime()" >
    ...
    <div class="toolbar">
        ...
        <a id="backButton" class="button" href="#"></a>
               <a class="button leftButton" type="cancel" href="stocklevelsHorner.asp" target="_self">Stock by Die</a>
...
<ul id="screen1" title="Stock by Die" selected="true">
	...
	rs.movefirst
rs.filter = "PART = '" & part & "' AND WAREHOUSE='Horner'"
