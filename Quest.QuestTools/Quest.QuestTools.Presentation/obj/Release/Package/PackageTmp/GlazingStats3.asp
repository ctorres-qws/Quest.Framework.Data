...
<form id="screen1" title="Glaze Stats" class="panel" name="Glaze" action="GlazingStats3.asp" method="GET" selected="true">
<fieldset>
   <div class="row">   
            <label>Job </label>
	...
	<li>Sealed Unit (Panel) - <%response.write Pcount%></li>
	<li>Sealed Unit (SP) - <%response.write SPcount%></li>
	<li>Sealed Unit (OV) - <%response.write OVcount%></li>
	<li>Sealed Unit (Door) - <%response.write Doorcount%></li>
	<li>Sealed Unit (SB) - <%response.write SBcount%></li>
	<li>Sealed Unit (Other) - <%response.write Ocount%></li>
