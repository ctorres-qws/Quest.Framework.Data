...
<ul id="screen1" title="Quest Dashboard" selected="true">
	<li class="group">Date Range</li>

	<li><form method="get" action="ojontruck.asp#_screen1" target="_self">
	yyyy-mm-dd<input type="text" name="D1" maxlength="10" size="10">to yyyy-mm-dd
	<input type="text" name="D2" maxlength="10" size="10">
