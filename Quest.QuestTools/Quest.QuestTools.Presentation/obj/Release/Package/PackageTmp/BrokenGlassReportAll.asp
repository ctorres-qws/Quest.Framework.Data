...
<!-- Two Versions of this Table Broken Glass Report only shows Unordered -->
<!-- Broken Glass Report All shows all items -->
...
<%
		...
		strSQL = "SELECT * FROM X_Broken ORDER BY Job, Floor ASC"
		rs.Cursortype = 2
		rs.Locktype = 3
...
<body>
	...
	<li class ="group"> <a href="BrokenGlassReport.asp" target = "_self">Switch to Unordered</a></li>
