...
<!-- N added to end for Nashua Version -->
...
strSQL = "SELECT * FROM Y_INV WHERE WAREHOUSE = 'NASHUA' AND AISLE = '" & afilter & "' ORDER BY RACK, SHELF ASC"
rs.Cursortype = 2
rs.Locktype = 3
...
<body>
    <div class="toolbar">
       ...
       <li class='group'><a href="stockbyrack2N.asp?aisle=<% response.write afilter %>" target="_self"> Switch to Row Form - Aisle <% response.write afilter %></a></li>
...
<td><a href="stockbyrackedit.asp?id=<% response.write id %>&aisle=<% response.write afilter %>&ticket=NASHUATABLE" target="_self">Manage</a></td>
</tr>
