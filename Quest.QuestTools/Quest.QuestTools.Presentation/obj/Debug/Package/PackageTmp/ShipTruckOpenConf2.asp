...
error = "Job, Floor, and Dock must all be filled in to add a new truck, Please retry"
	...
	'RecordSet of all trucks
		...
		strSQL = "SELECT * FROM X_SHIP_TRUCK ORDER BY truckNum DESC"
...
response.write " <a class='whiteButton' href=' ShipTruckScan.asp?truck=" & truckID & "&barcode=' target='_self'>Scan Items to Truck</a>"
