...
<body>
    ...
    <form id="igline" title="Panel Scan" class="panel" name="igline" action="ScanPanel.asp" method="GET" selected="true">
         <h2>Panel Scan</h2>
		 ...
		 EmployeeName = "_"
		 CutColour ="whiteButton"
		 BendColour ="whiteButton"
		 ShipColour ="whiteButton"
		 ReceiveColour ="whiteButton"
		 ...
		 Select Case ScanType
			Case "Cut"
				...
				EmployeeName = "Karim"
			Case "Bend"
				BendColour = "redButton"
				EmployeeName = "Ashur"
			Case "Ship"
				ShipColour = "redButton"
				EmployeeName = "Amell"
			Case "Receive"
				ReceiveColour ="redButton"
				EmployeeName = "Assembly"
		 End Select
		 %>
		...
		<div class="row">
			<table>
			<tr>
				<td><a class="<%response.write CutColour%>" href="ScanPanel.asp?ScanType=Cut" target = "_self" >Sheet Cut</a> </td>
				<td><a class="<%response.write BendColour%>" href="ScanPanel.asp?ScanType=Bend" target = "_self" >Panel Bend </a> </td>
			</tr>
			<tr>
				<td><a class="<%response.write ShipColour%>" href="ScanPanel.asp?ScanType=Ship" target = "_self" >Panel Sent </a> </td>
				<td><a class="<%response.write ReceiveColour%>" href="ScanPanel.asp?ScanType=Receive" target = "_self" > Panel Received </a> </td>
			</tr>
			</table>
		</div>
        ...
        <fieldset>
	        ...
	        <div class="row">
                ...
                <input type="text" name='employeeID' id='inputbce' value = '<% response.write EmployeeName %>' >
            </div>
