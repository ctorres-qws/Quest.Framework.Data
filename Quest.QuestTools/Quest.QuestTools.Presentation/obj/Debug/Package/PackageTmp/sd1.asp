...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"
         "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
            <!--#include file="connect_barcodesd.asp"-->
...
sizecheckid = 0
  ...
  Do while not rs.eof
  if rs("BARCODE") = bc AND rs("DEPT") = "SLIDING" then
  sizecheckid = rs("ID")
  end if
  rs.movenext
  loop
...
<body>
    <div class="toolbar">
       ...
       <form id="scansd" title="Sliding Door Scan" class="panel" name="scansd" action="sd1.asp" method="GET" selected="true">
         <% if employeeID = "" then
		 response.write ""
		 else %>
			<div class="row">
    ...
    if ( barcode.length == 4 ) {
        ...
        <BR>
        <a class="whiteButton" href="javascript:scansd.submit()">Submit</a>
