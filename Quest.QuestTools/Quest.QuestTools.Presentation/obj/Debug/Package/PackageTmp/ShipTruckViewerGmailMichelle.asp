...
strSQL = "SELECT * FROM X_SHIP_MICHELLE WHERE [DELETED] = FALSE AND [Truck] = " & truck & " ORDER BY TAG ASC"
rs.Cursortype = 2
rs.Locktype = 3
...
strSQL2 = "SELECT top 1 * FROM X_SHIP_TRUCK_MICHELLE WHERE [ID] = " & Truck 
rs2.Cursortype = 2
rs2.Locktype = 3
'if CountryLocation = "USA" then
...
<%
	ChangeCounter= 0
	for i=0 to JobLimit
		strSQL4 = "SELECT * FROM X_SHIP_MICHELLE WHERE [DELETED] = FALSE AND ([JOB] = '" & iJob(i) & "' and [Floor] = '" & iFloor(i) & "')"
...
OECount = rs5.RecordCount
	...
	response.write "<tbody class='hide' id='truck" & ChangeCounter & "' style='display:block' >"
...
OECount = rs5.RecordCount
	...
	response.write "</td></tr>"
	response.write "<tbody class='hide' id='othertruck" & ChangeCounter & "' style='display:block' >"
...
TotalCount = rs5.RecordCount
	...
	response.write "</td></tr>"
	response.write "<tbody class='hide' id='Backorder" & ChangeCounter & "' style='display:block' >"
