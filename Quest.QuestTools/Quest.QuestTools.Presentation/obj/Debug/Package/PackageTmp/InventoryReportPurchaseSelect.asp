...
<!--Copy of the InventoryReportSelect Page, but for Purchases in the month selected - June 2017-->
...
<body>
    ...
    <form id="snapshot" title="Take Inventory Snapshot" class="panel" name="snapshot" action="InventoryReportPurchaseValue.asp" method="GET" target="_self" selected="true">
