	...
	Function GetConnectionStrDefault(b_SQLServer)
		...
		If (b_SQLServer) Then
			...
			Select Case(gi_Env)
				...
				Case c_ENV_Prod
					str_Ret = "Provider=SQLOLEDB; Data Source=qwtordb1\quest;User Id=QWS-Prod; Password=Test123;Initial Catalog=QWS_prod"
				Case Else
					'c_ENV_Dev, c_ENV_Local
...
'Query - adOpenForwardOnly, adLockReadOnly
	...
	Sub SendEmail(str_To, str_Subject, str_Body)
		...
		o_Mail.To = "mbernholtz@questwindows.com, mdungo@questwindows.com, aramirez@questwindows.com" 'TEST
	...
	Function PrefAddTransfer(str_ID, str_Warehouse_Out, str_Warehouse_In, str_Part, str_Qty, str_Colour, str_LengthFt, b_Debug, str_Page, str_Note, str_PO, str_Referrer)
		...
		cn_DB.Open gstr_DB_Pref ' "Provider=SQLOLEDB; Data Source=qwtordb1\quest;User Id=QWS-Prod; Password=Test123;Initial Catalog=QWS_prod"
		cn_DB.BeginTrans
