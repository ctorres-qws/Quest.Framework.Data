...
strSQL = "SELECT * FROM Y_INV WHERE WAREHOUSE = 'SCRAP' AND DATEOUT >= #2018/11/01# AND DATEOUT <= #2018/11/30# Order by PART ASC"
...
<P> Reporting Value of Inventory in SCRAP Nov 2018 </P>
