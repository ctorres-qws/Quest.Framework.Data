...
strSQL = "Select * FROM X_BARCODEGA WHERE DAY = " & sDAY & " AND MONTH =" & SMonth & " AND YEAR = " & SYear &"  AND UCASE(Left(BARCODE,2)) = 'GT' ORDER BY DATETIME DESC"
...
<ul id="screen1" title="Quest Dashboard" selected="true">
		...
		<li><a href = "GlassTV.asp" target= "_self"> <% response.write "Total Service Glass: " & totalg %></a></li>
		<li><% response.write "Forel Service Glass: " & totalgf %></li>
		<li><% response.write "Willian Service Glass: " & totalgw %></li>
