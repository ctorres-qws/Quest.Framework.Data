...
<body>
    ...
    <form id="igline" title="Glazing Scan" class="panel" name="igline" action="ScanJRMatching.asp" method="GET" selected="true">
         <h2>Bundle Label</h2>
        ...
        <fieldset>
             ...
             <div class="row">
                <label>Bundle</label>
                <input type="text" name='JRLabel' id='inputbcw' >
            </div>
