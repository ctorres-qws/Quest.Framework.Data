...
strSQL = "SELECT * FROM Y_INV WHERE WAREHOUSE = 'GOREWAY' ORDER BY AISLE, RACK, SHELF ASC"
rs.Cursortype = 2
rs.Locktype = 3
...
<body onload="startTime()" >
    ...
    <div class="toolbar">
        ...
        <a id="backButton" class="button" href="#"></a>
                <a class="button leftButton" type="cancel" href="stock.asp" target="_self">Stock by Die</a>
