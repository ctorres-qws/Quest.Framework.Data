...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"
		 ...
		 <!--Tilton version of Stock levels, created for Shaun Levy and Michael Angel by Michael Bernholtz, July 20, 2015 -->

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
  <title>Stock Levels - Tilton</title>
...
<ul id="screen1" title="Stock Level - Tilton" selected="true">            


<%
Set rs = Server.CreateObject("adodb.recordset")
strSQL = "SELECT * FROM Y_INV WHERE WAREHOUSE = 'TILTON'  OR WAREHOUSE = 'TILTON(WIP)' order by PART ASC"
rs.Cursortype = 2
rs.Locktype = 3
...
response.write "<li class='group'>Stock by Die - Tilton Only</li>"
...
do while not rs2.eof
	...
	if partqty = 0 and allocatedqty = 0 and paintedqty = 0 then
		...
		response.write "<tr><td><a href='stockbydieTilton.asp?part=" & rs2("Part") & "' target='_self'>" & rs2("part") & "</a></td><td>" & rs2("Description") & "</td><td>" & partqty & "</td><td>" & allocatedqty & "</td><td>" & paintedqty & "</td><td>" & Totalqty & "</td></tr>"
	end if 
