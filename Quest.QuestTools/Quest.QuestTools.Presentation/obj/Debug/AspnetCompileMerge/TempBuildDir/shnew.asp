...
<body>
    <div class="toolbar">
        <h1 id="pageTitle"></h1>
        <a class="button leftButton" type="cancel" href="index.html#_Ship" target="_webapp">Shipping</a>
        </div>
   
   
   
    <form id="ship" title="Shipping Scan" class="panel" name="ship" action="shscan.asp" method="GET" target="_self" selected="true">
