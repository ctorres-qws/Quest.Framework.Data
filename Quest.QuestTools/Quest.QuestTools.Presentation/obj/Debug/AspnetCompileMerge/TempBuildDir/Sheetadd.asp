...
<!-- Sheet Inventory added March 2017-->
...
<body>
    ...
    <form id="enter" title="Add Sheet" class="panel" name="enter" action="sheetconf.asp" method="GET" target="_self" selected="true">
              
	
	<h2>New Sheet to Add to Inventory</h2>
		<fieldset>	
		<div class="row">
			<label>Job</label>
		...
		<div class="row">
			...
			<select name="Location">
				<option value= "GOREWAY SHELF" >GOREWAY SHELF</option>
				<option value= "GOREWAY FLOOR">GOREWAY FLOOR</option>
				<option value= "NASHUA SHELF" >NASHUA SHELF</option>
				<option value= "NASHUA FLOOR" >NASHUA FLOOR</option>
			</select>
		</div>
		<div class="row">
			<label>Qty</label>
