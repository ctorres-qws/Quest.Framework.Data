...
<!-- Created February 25th, by Michael Bernholtz - Label to be Printed for Spacers-->
...
Set rs = Server.CreateObject("adodb.recordset")
		strSQL = "SELECT MSP.ItemName, SP.Identifier, SP.EntryDate, SP.printed, SP.Id FROM QC_SPACER AS SP INNER JOIN QC_MASTER_SPACER AS MSP ON MSP.id = SP.MasterID ORDER BY MASTERID ASC"
