...
strSQL = "SELECT * FROM TEST_WaterFilter ORDER BY DATE DESC"
rs.Cursortype = 2
rs.Locktype = 3
...
<body>
    <div class="toolbar">
        ...
        <ul id="Profiles" title=" Water Filter " selected="true">
        <li class='group'>Water Filter Test </li>
         <a class="whiteButton" href="QCTest_WaterFilterEnter.asp" target='_Self'>Add New Result</a>
<% 

response.write "<li> Click on the Headers of each column to sort Ascending/Descending</li>  "
response.write "<li><table border='1' class='sortable' ><thead><tr><th>Date</th><th>Time</th><th>Level</th><th>Filter Passed?</th><th>Name</th><th>Notes</th></tr></thead><tbody>"
if rs.eof then
...
do while not rs.eof
	...
	response.write "<td>" & RS("PassFail") & "</td>"
