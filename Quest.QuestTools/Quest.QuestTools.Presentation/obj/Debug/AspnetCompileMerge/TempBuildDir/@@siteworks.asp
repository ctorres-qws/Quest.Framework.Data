<%
	...
	'gstr_DB_Access_Prod = "DRIVER={Microsoft Access Driver (*.mdb)}; " & "DBQ=F:\database\quest.mdb;" 'need to update to point to new server
	'gstr_DB_Access_Prod = "Provider=Microsoft.Jet.OLEDB.4.0; Data Source=F:\Database\Quest.mdb;User Id=Admin; Password=;"
	gstr_DB_Access_Prod = "DRIVER={Microsoft Access Driver (*.mdb)}; " & "DBQ=\\QWTORDB1\F Database\quest.mdb;" 'need to update to point to new server
	'gstr_DB_Access_Prod = "Provider=Microsoft.Jet.OLEDB.4.0; Data Source=\\QWTORDB1\F Database\Quest.mdb;User Id=Admin; Password=;" ' 6 sec
