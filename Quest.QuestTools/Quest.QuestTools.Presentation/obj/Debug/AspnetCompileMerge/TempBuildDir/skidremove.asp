...
<!-- Can be autocalled by Skidreport using a report flag-->
...
if bc = "" then
	...
	if not rs.bof then
			...
			SQL1 = "UPDATE SkidItem Set Flushed = true, FlushedDate ='" & currentDate & "' WHERE BARCODE = '" & bc & "' AND Flushed = false"
...
<body>
   ...
   <form id="DeleteSkidItem" title="Delete from Skid Scan" class="panel" name="DeleteSkidItem" action="skidremove.asp" method="GET" selected="true">
         <% if bc = "" then
		 response.write ""
		 else %>
			<div class="row">
