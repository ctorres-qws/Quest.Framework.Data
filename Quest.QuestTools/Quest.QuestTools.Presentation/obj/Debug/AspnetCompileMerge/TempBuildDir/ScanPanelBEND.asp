...
Select Case Machine	
	Case "1"
		OperatorName = "All Steel"
	Case "2" 
		OperatorName = "Toskar"
	Case "3"
		OperatorName = "Schechtl"
	Case Else
		OperatorName = "Ashur"
End Select
...
<body>
    ...
    <form id="igline" title="BEND" class="panel" name="igline" action="ScanPanelBend.asp" method="GET" selected="true">
         <h2>Panel Scan</h2>
		 	 
		 
		<div class="row">
			<a class="redButton" href="ScanPanelALL.asp?ScanType=BEND" target = "_self" >Full Menu</a> 
		</div>
        ...
        <fieldset>
	        ...
	        <div class="row">
                ...
                <input type="text" name='employeeID' id='inputbce' value = '<%response.write OperatorName%>' >
            </div>
			...
			<div class="row">
				...
				<input type="hidden" name='Machine' id='Machine' value='<%response.write Machine%>' />
            </div>
            </fieldset>
			 <BR>
