...
<ul id="screen1" title="Edit Color" selected="true">
...
response.write "<li><table border='1' class='sortable'><tr><th>JOB</th><th>Paint Code</th><th>Paint Company</th><th>Paint Location</th><th>Ext / Int</th><th>Price Category</th><th>Active</th><th>Extrusion</th><th>Sheet</th><th>Manage</th></tr>"
do while not rs.eof
response.write "<tr>"
...
response.write "<td><a href =><a href='coloreditform.asp?cid=" & rs.fields("ID") & "' target='_self' >Manage</td>"
response.write "</tr>"
