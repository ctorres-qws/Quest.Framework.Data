...
strSQL = "SELECT top 1000 * FROM Z_GLASSDB ORDER BY ID DESC"
...
<body>
    ...
    <div class="toolbar">
        ...
        <form id="Report" title="View Filtered Glass" class="panel" action="GlassToolViewWait.asp" name="Report"  method="GET" target="_self" selected="true" > 
	<fieldset>
...
Response.write "<li><table border='1' ><thead><th>ID</th><th>Job</th><th>Floor</th><th>Tag</th><th>Width</th><th>Height</th><th>1 Mat</th><th>1 SPAC</th><th>2 Mat</th><th>Type</th><th>Order</th><th>PO</th><th width ='8pt'>QT File Name</th><th>Order Date</th><th>Status</th><th>Notes</th></thead><tbody>"
