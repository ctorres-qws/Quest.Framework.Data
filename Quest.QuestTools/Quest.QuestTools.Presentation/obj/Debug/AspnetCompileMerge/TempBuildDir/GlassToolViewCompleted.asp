...
<% 
response.write "<li class='group'>Glass in the warehouse </li>"
...
if isdate(rs("CompletedDate")) and not isdate(rs("ShipDate")) then
	response.write "<tr>"
		...
		Response.write "<td><a href='GlassManageForm.asp?gid=" & rs.fields("ID") & "&ticket=completed' target='_self' >Manage Glass</a> </td>" 
		Response.write "<td><a href='GlassManageTimeLineForm.asp?gid=" & rs.fields("ID") & "&ticket=completed' target='_self' >Manage Time Line</a> </td>" 
	Response.write "</tr>"
