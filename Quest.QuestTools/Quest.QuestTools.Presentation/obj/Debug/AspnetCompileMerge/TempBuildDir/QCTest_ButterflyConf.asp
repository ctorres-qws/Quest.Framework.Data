...
<!-- Confirm Page - Entered from QCTest_ButterflyEnter.asp -->
...
strSQL = "SELECT * FROM TEST_Butterfly"
rs.Cursortype = 2
rs.Locktype = 3
...
<body >
    ...
    <div class="toolbar">
        ...
        <a id="backButton" class="button" href="#"></a>
                <a class="button leftButton" type="cancel" href="QCTest_ButterflyENTER.asp?Glassline=<%response.write Glassline%>" target="_self">Back</a>
...
<ul id="Report" title="Added" selected="true">
	...
	<li><% response.write "Glassline: " & Glassline %></li>
	<a class="whiteButton" href="QCTest_Butterfly.asp?Glassline=<%response.write Glassline%>" target="_self">Confirm and Return</a>
</ul>
