...
<!-- Entry Page - Confirms to FORM_QAConf.asp -->

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
  <title>New Quality Audit Result</title>
...
<body>
    <div class="toolbar">
        <h1 id="pageTitle"></h1>
        <a class="button leftButton" type="cancel" href="FORM_QA.asp" target="_self">Quality</a>
        </div>
            
              <form id="enter" title="Enter New Result" class="panel" name="enter" action="FORM_QAConf.asp" method="GET" target="_self" selected="true">

        <h2>Enter Quality Audit Record:</h2>
	...
	<div class="row">
		<label>NDMR</label>
		<input type="text" name='NDMR' id='NDMR' value = 'N/A' />
    </div> 
