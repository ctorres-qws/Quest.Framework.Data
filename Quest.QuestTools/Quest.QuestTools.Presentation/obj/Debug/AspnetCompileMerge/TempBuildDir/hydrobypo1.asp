...
<body onload="startTime()" >
    ...
    <div class="toolbar">
        <h1 id="pageTitle"></h1>
              ...
              <form id="edit" title="Select Stock by PO" class="panel" name="edit" action="hydrobypo.asp" method="GET" target="_self" selected="true" > 
        <h2>Search HYDRO Stock by PO</h2>
...
<fieldset>
     <div class="row">
        ...
        <BR>
        <a class="whiteButton" href="javascript:edit.submit()">Search HYDRO stock by PO</a><BR>
