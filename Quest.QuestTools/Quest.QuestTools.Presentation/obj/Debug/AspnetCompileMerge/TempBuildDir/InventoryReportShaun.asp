...
strSQL = "SELECT * FROM Y_INV WHERE (WAREHOUSE = 'WINDOW PRODUCTION' and Colour LIKE  '%SAT%' ) order by PART ASC"
rs.Cursortype = 2
rs.Locktype = 3
rs.Open strSQL, DBConnection
rs.filter = "DATEOUT >= '07/01/2016' AND DATEOUT <= '07/31/2016'"
...
<h2> Inventory from Window Production in SAT </h2>
<h3> Using Inventory from: <%Response.write ReportName%></h3>
<h3> Aluminium Price: <%Response.write AlumPrice%></h3>

<a href="InventoryReportExcel.asp?AlumPrice=<%response.write AlumPrice%>&ReportName=<%response.write ReportName%>" target="_self"><b>Download Excel Copy</a>
