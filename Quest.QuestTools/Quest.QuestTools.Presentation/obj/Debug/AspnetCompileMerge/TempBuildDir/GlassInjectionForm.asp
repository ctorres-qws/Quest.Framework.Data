...
%>   
        ...
        <form id="enter" title="Add Glass" class="panel" name="enter" action="GlassInjectionConf.asp" method="GET" target="_self" selected="true">

        <h2>Add Glass Manually</h2>
		<fieldset>
			<div class="row">     
                <label>Job</label>
			...
			<div class="row">     
                ...
                <input type="text" name='TYPEG' id='TYPEG' >
            </div>
			<div class="row">     
...
%>
<form id="adminpass" title="Administrative Tools" class="panel" name="enter" action="GlassInjectionForm.asp" method="post" target="_self" selected="True">
