...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"
         "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
            <!--#include file="connect_barcodeov.asp"-->
...
sizecheckid = 0
  ...
  Do while not rs.eof
  if rs("BARCODE") = bc AND rs("DEPT") = "Awning" then
  sizecheckid = rs("ID")
  end if
  rs.movenext
  loop
...
<body>
    <div class="toolbar">
       ...
       <form id="scanov" title="Awning Door Scan" class="panel" name="scanov" action="ov1.asp" method="GET" selected="true">
         <% if employeeID = "" then
		 response.write ""
		 else %>
			<div class="row">
    ...
    if ( barcode.length == 4 ) {
        ...
        <BR>
        <a class="whiteButton" href="javascript:scanov.submit()">Submit</a>
