...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"
		 ...
		 <!--Created January 2015 to be both Table and Row form to match StockLevels Durapaint and Horner for Shaun Levy-->		
...
strSQL = "SELECT * FROM Y_INV WHERE WAREHOUSE = 'DURAPAINT' OR WAREHOUSE = 'DURAPAINT(WIP)' OR WAREHOUSE = 'HORNER'  OR WAREHOUSE = 'TILTON'  OR WAREHOUSE = 'TORBRAM' ORDER BY ALLOCATION DESC"
rs.Cursortype = 2
rs.Locktype = 3
...
<body onload="startTime()" >
    ...
    <div class="toolbar">
        ...
        <a id="backButton" class="button" href="#"></a>
                <a class="button leftButton" type="cancel" href="stocklevelsDH.asp" target="_self">Stock Level</a>
...
<ul id="screen1" title="Stock by Die" selected="true">
	...
	Response.Write "<li class='group'><a href='stockbydieDHTable.asp?part=" & part & "' target='_self' >Stock (Row Form) - Switch to Table Form</a></li>"
