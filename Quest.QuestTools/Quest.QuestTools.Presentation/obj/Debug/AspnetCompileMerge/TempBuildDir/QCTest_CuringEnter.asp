...
<!-- Entry Page - Confirms to QCTest_CuringConf.asp -->
...
<body>
    <div class="toolbar">
        <h1 id="pageTitle"></h1>
        <a class="button leftButton" type="cancel" href="QCTEST_Curing.asp" target="_self">Curing Test</a>
        </div>

            
              <form id="enter" title="Enter New Result" class="panel" name="enter" action="QCTEST_Curingconf.asp" method="GET" target="_self" selected="true">

        <h2>Enter New Curing Result:</h2>
	...
	<div class="row">
		...
		<input type="text" name='CuringTime' id='CuringTime' >
    </div>
