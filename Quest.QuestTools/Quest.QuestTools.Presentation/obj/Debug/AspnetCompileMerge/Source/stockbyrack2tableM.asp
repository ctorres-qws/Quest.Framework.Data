...
<!-- M added to end for Milvan Version by Annabel Ramirez Feb 2020 -->
...
strSQL = "SELECT * FROM Y_INV WHERE WAREHOUSE = 'MILVAN' AND AISLE = '" & afilter & "' ORDER BY RACK, SHELF ASC"
rs.Cursortype = 2
rs.Locktype = 3
...
<body>
    <div class="toolbar">
       ...
       <li class='group'><a href="stockbyrack2M.asp?aisle=<% response.write afilter %>" target="_self"> Switch to Row Form - Aisle <% response.write afilter %></a></li>
...
do while not rs.eof
	...
	if rack = rs("rack") then
		...
		response.write "<li><table border='1' class='sortable'><tr><th>Shelf</th><th>Part</th><th>Quantity</th><th>PO</th><th>Bundle</th><th>External Bundle</th><th>Colour</th><th>Input Date</th><th>Size</th><th>Manage</th></tr>"
...
<td><a href="stockbyrackedit.asp?id=<% response.write id %>&aisle=<% response.write afilter %>&ticket=MILVANTABLE" target="_self">Manage</a></td>
</tr>
