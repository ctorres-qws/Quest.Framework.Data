...
<!-- Entry Page - Confirms to QCTest_SuperSpacerConf.asp -->

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
  <title>New SuperSpacer Result</title>
...
<body>
    <div class="toolbar">
        <h1 id="pageTitle"></h1>
        <a class="button leftButton" type="cancel" href="QCTEST_SUPERSPACER.asp" target="_self">SuperSpacer Test</a>
        </div>

            
              <form id="enter" title="Enter New Result" class="panel" name="enter" action="QCTEST_SUPERSPACERconf.asp" method="GET" target="_self" selected="true">

        <h2>Enter New SuperSpacer Result:</h2>
