...
<body>
    <div class="toolbar">
        <h1 id="pageTitle"></h1>
        <a class="button leftButton" type="cancel" href="shnew.asp" target="_webapp">Floor</a>
        </div>
...
%>
    ...
    var textbox = document.getElementById("inputbcw");
		...
		response.write bc & " Scanned" 
		end if 
		%><BR>
            <BR> <a href="shreport.asp?tn=<% response.write tablename %>" target="_self" a class="whiteButton">Shipping Report</a>
