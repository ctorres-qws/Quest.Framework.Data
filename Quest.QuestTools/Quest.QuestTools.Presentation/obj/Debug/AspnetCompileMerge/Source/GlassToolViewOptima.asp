...
if isdate(rs("OptimaDate")) and not isdate(rs("CompletedDate")) and not isdate(RS("EXTReceived")) and not isdate(RS("IntReceived")) then
	response.write "<tr>"
		...
		Response.write "<td><a href='GlassManageForm.asp?gid=" & rs.fields("ID") & "&ticket=optima' target='_self' >Manage Glass</a> </td>" 
		Response.write "<td><a href='GlassManageTimeLineForm.asp?gid=" & rs.fields("ID") & "&ticket=optima' target='_self' >Manage Time Line</a> </td>" 
	Response.write "</tr>"
