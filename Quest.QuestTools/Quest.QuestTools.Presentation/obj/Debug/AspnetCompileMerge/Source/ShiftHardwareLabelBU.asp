...
<table align= "center" frame="box" width="300px" cellspacing="1" cellpadding="1">
	...
	<tr>
		...
		<td align = 'Left' style="font-size:75%;"> <b>Buggy <%response.write PositionI %><b></td>
	</tr>
	...
	<tr>
		<td align = 'Left' style="font-size: 75%;"> <b> <%response.write Barcode  %><b></td>
	</tr>
...
%>
<meta http-equiv="refresh" content="0;url=<%response.write ReturnSite & "?Job=" & JOB & "&Floor=" & FLOOR & "&PositionX= " & NEXTX & "&PositionY=" & NEXTY & "&PositionI=" & NEXTI & "&Side=" & NEXTSIDE & "&Ticket=" & Ticket %>" />
</body>
</html>
