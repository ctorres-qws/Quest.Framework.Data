...
<body>
    <div class="toolbar">
        ...
        <a class="button leftButton" type="cancel" href="ShippingTruckEdit.asp" target="_self">Select Truck</a>
    </div>
	
	    <form id="EditTruck" title="Update Shipping Trucks" class="panel" name="EditTruck" action="ShippingTruckEditConf.asp" method="GET" target="_self" selected="true">
