...
strSQL = FixSQL("SELECT * FROM X_SHIPPING_TRUCK WHERE [Active] =  FALSE ORDER BY ID DESC")
...
do while not rs.eof
	...
	response.write "<td><a class='greenButton' href='ShippingTruckViewer.asp?truck=" & RS("ID") & "&Ticket=Closed'  target='_self' >View All Items </a></td>"
	response.write "<td><a class='greenButton' href='ShippingTruckCompare.asp?Job=" & RS("Job") & "&Floor=" & RS("Floor") & "&Ticket=Closed' target='_self' >Check for Missing </a></td>"
	response.write "</tr>"
	rs.movenext
loop
