...
<body>
 <div class="toolbar">
        <h1 id="pageTitle">Hardware List</h1>
<%
			HomeSite = "index.html"
			HomeSiteSuffix = ""
%>
...
Response.WRITE "<tr><th>Part</th><th>Description</th><th>Quantity (SL)</th><th>PO</th><th>ExitDate</th></tr>"
...
Response.write "<td>" & rs("ExitDate") & " </td>"
