...
<% 
response.write "<li class='group'>Glass Ready to be produced</li>"
...
if (isdate(rs("EXTReceived")) and isdate(rs("IntReceived"))) and not isdate(RS("Completeddate"))  then
	response.write "<tr>"
		...
		Response.write "<td><a href='GlassManageForm.asp?gid=" & rs.fields("ID") & "&ticket=received' target='_self' >Manage Glass</a> </td>" 
		Response.write "<td><a href='GlassManageTimeLineForm.asp?gid=" & rs.fields("ID") & "&ticket=received' target='_self' >Manage Time Line</a> </td>" 
	Response.write "</tr>"
