...
<body>
 <div class="toolbar">
        ...
        <ul id="Profiles" title="Active Floors" selected="true">
        <li>Floors Available on Active Trucks</li>

	
<% 

Set rs = Server.CreateObject("adodb.recordset")
strSQL = FixSQL("SELECT * FROM X_SHIP_TRUCK WHERE [Active] = TRUE ORDER BY ID ASC")
rs.Cursortype = 2
rs.Locktype = 3
if CountryLocation = "USA" then
...
do Until i> Joblimit
	...
	response.write "<td><a class='greenButton' href='ShipFloorViewer.asp?Job=" & JOB & "&Floor=" & FLOOR & "&ticket=open' target='_self' >View All Items </a></td>"
	response.write "</tr>"
