...
<table align= "center" valign ="top" width="500" cellspacing="1" cellpadding="1" Style="font-size: 190%;">
	...
	<td Style="font-size: 45%"><% response.write UCASE(Barcode) %></td>
	</tr>
	...
	<tr> 
		...
		<td align = 'center' valign = 'top' rowspan ="2" ><img align = 'center'  src="http://chart.apis.google.com/chart?cht=qr&chs=100x100&chl=<% response.write UCASE(Barcode) %>&chld=H|0" alt="Barcode" /></td>
		<td Style="font-size: 85%;" align= "center" ><b> Panel # </b></td>
	</tr>	
	<tr>
	<td Style="font-size: 165%;" align = 'center' valign = 'top' ><b><%response.write RS3("DIS_UData6_PRT") %> </b></td>

	<td align = 'center' valign = 'top' rowspan ="2" Style="font-size: 215%;"><b><%response.write RS3("IOrder") %></b></td>
	</tr>
