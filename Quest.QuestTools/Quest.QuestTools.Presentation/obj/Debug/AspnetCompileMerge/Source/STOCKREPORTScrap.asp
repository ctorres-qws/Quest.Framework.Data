<!-- Scrap Values - For Diane Cook Jan 2020 -->
<!-- Michael Bernholtz-->
...
strSQL = "SELECT * FROM Y_INV WHERE WAREHOUSE = 'SCRAP' AND Year(MODIFYDATE) = '2019' order by PART ASC"
rs.Cursortype = GetDBCursorType
rs.Locktype = GetDBLockType
rs.Open strSQL, DBConnection

'Create a Query
    SQL2 = "SELECT * FROM Y_MASTER WHERE inventoryType = 'Extrusion' order BY ID DESC"
'Get a Record Set
...
<P> Reporting Value of Inventory in SCRAP in 2019</P>
...
%>
  ...
  <tr><td><% response.write invpart %></td>
	...
	<td><% response.write ModifyDate %></td>
