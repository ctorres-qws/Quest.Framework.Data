...
strSQL = "SELECT * FROM TEST_Curing ORDER BY DATE DESC"
rs.Cursortype = 2
rs.Locktype = 3
...
<body>
    <div class="toolbar">
        ...
        <ul id="Profiles" title=" Curing" selected="true">
        <li class='group'>Curing Test </li>
         <a class="whiteButton" href="QCTest_CuringEnter.asp" target='_Self'>Add New Result</a>
<% 

response.write "<li> Click on the Headers of each column to sort Ascending/Descending</li>  "
response.write "<li><table border='1' class='sortable' ><thead><tr><th>Date</th><th>Curing Time</th><th>Width</th><th>Adhesion Passed?</th><th>Name</th><th>Notes</th><th>File</th></tr></thead><tbody>"
if rs.eof then
...
do while not rs.eof
	...
	response.write "<td>" & RS("CuringTime") &"</td>"
