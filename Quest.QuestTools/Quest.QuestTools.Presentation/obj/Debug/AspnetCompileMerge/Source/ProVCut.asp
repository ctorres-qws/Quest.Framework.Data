...
<!-- Consumption report giving Todays Cycle cuts from the Vertical Machines-->
<!-- Will be copied into a Horizontal Machine File-->
<!-- Created December 10th, 2014 by Michael Bernholtz - Requested by Michael Angel-->

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
  <title>Vertical Cycle Cuts</title>
...
<body>
    <div class="toolbar">
        ...
        <ul id="Profiles" title="Vertical Cuts: <% response.write DateAdd("d",-1,Date())%>" selected="true">
        <li>Vertical Cut Report</li>
...
strSQL = FixSQL("SELECT * FROM ProECOVert WHERE [StartDate] = #" & DateAdd("d",-1,Date()) & "# ORDER by JobNumber ASC")
...
response.write "<li><table border='1' class='sortable'><tr><th>Cut Cycle</th><th>Cut Status</th><th>Start Date</th><th>End Date</th></tr>"
Set rs = Server.CreateObject("adodb.recordset")
strSQL = FixSQL("SELECT * FROM ProQVert WHERE [StartDate] = #" & DateAdd("d",-1,Date()) & "# ORDER by JobNumber ASC")
rs.Cursortype = GetDBCursorType
rs.Locktype = GetDBLockType
rs.Open strSQL, DBConnection
do while not rs.eof
