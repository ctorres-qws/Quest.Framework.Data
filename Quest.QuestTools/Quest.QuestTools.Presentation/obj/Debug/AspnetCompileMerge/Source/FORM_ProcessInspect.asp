...
strSQL = "SELECT * FROM FORM_ProcessInspect ORDER BY DATE DESC"
rs.Cursortype = 2
rs.Locktype = 3
...
<body>
    <div class="toolbar">
        ...
        <li class='group'>Window Inspection</li>
         <a class="whiteButton" href="FORM_ProcessInspectEnter.asp" target='_Self'>Add New Result</a>
<% 

response.write "<li> Click on the Headers of each column to sort Ascending/Descending</li>  "
response.write "<li><table border='1' class='sortable' ><thead><tr><th>Date</th><th>Tag</th><th>Window Ok?</th><th>Issue</th><th>Checked By</th></tr></thead><tbody>"
if rs.eof then
