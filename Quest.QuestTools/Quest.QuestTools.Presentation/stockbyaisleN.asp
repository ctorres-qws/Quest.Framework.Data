...
strSQL = "SELECT * FROM Y_INV WHERE WAREHOUSE = 'NASHUA' ORDER BY AISLE, RACK, SHELF DESC"
'rs.Cursortype = 2
'rs.Locktype = 3
...
shelf = rs("shelf")
	...
	response.write "<a href='stockbyrack2N.asp?aisle=" & rs("aisle") & "' target='_self'><li>Aisle " & rs("aisle") & "</a></li>"
	end if
