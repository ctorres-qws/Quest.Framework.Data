...
namespace Quest.ScantToPrint.Presentation
{
    ...
    public class PDFcreator
    {
        ...
        public void CreatePDF6x4FromAnotherLine(BarcodeReading barcodeReading, string color)
        {
            PdfWriter writer = new PdfWriter(string.Format(@"..\..\Labels\{0}.pdf", barcodeReading.Barcode));
            PdfDocument pdf = new PdfDocument(writer);
            pdf.SetDefaultPageSize(new iText.Kernel.Geom.PageSize(new iText.Kernel.Geom.Rectangle(576, 384)));
            ...
            table.AddCell(cellQRTR);
            //table.AddCell(new Cell(2, 1).SetBorder(Border.NO_BORDER).SetBackgroundColor(GetRgb(color)));
            table.AddCell(cellCentralContent.SetBorder(new DashedBorder(GetRgb("#ccff00"), 1)));
            ...
            Paragraph pleftColor = new Paragraph();
            leftColor.AddCell(new Cell(5, 1).Add(pleftColor).SetBorder(Border.NO_BORDER).SetBackgroundColor(GetRgb(color)).SetBorder(new SolidBorder(GetRgb("#ccff00"), 2)));
            ...
            Paragraph prightColor = new Paragraph();
            rightColor.AddCell(new Cell(5, 1).Add(prightColor).SetBorder(Border.NO_BORDER).SetBackgroundColor(GetRgb(color)).SetBorder(new SolidBorder(GetRgb("#ccff00"), 2)));
            ...
            Paragraph pDate = new Paragraph("DATE:").SetTextAlignment(TextAlignment.LEFT).SetFontSize(14);
            Paragraph pDateTimeInfo = new Paragraph(barcodeReading.ScanDate.ToString("MMM-dd-yyyy hh:mm tt").ToUpper()).SetTextAlignment(TextAlignment.LEFT).SetFontSize(14);
            Paragraph pLine = new Paragraph(string.Format("L{0}", barcodeReading.Line.ToString())).SetTextAlignment(TextAlignment.CENTER).SetFontSize(20).SetBold().SetBorder(new SolidBorder(1)).SetBackgroundColor(GetRgb("#ccff00"));
            ...
            tableBottom.AddCell(new Cell(1, 6).Add(new Paragraph()).SetBorder(new SolidBorder(GetRgb("#ccff00"), 2)).SetTextAlignment(TextAlignment.CENTER).SetMarginLeft(10).SetWidth(new UnitValue(UnitValue.PERCENT, 100)).SetBackgroundColor(GetRgb(color)).SetHeight(new UnitValue(UnitValue.POINT, 30)));
            Cell cellQRTR2 = new Cell(2, 1).SetBorder(Border.NO_BORDER);
            cellQRTR2.Add(imgQR);
